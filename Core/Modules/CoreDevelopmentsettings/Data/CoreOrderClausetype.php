 ...
 * @author ramesh
 */
class Core_Modules_CoreDevelopmentsettings_Data_CoreOrderClausetype
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_orderclausetype");
            $registerController->setNodeNameData("core_orderclausetype");
            $registerController->setDisplayValue("Order Clause Type");
            ...
            $registerController->setRegisternodeId("core_orderclausetype");           
            $registerController->setTablename("core_orderclausetype");
