...
class Core_Modules_CoreDevelopmentsettings_Data_CoreWhatsappSettings
{
    ...
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setMandotatoryAdd("username|password|identity|active_status");
            $registerController->setMandotatoryEdit("username|password|identity");
            ...
            $registerController->setSearch("username|identity");
