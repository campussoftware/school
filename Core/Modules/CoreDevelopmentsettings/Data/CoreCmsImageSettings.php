...
class Core_Modules_CoreDevelopmentsettings_Data_CoreCmsImageSettings
{
    ...
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setMandotatoryAdd("node_settings_id|name|witdthvalue|heightvalue");
            $registerController->setMandotatoryEdit("node_settings_id|name|witdthvalue|heightvalue");
            ...
            $registerController->setReadonlyEdit("node_settings_id|name");
            ...
            $registerController->setNumberattribute("witdthvalue|heightvalue");
            $registerController->setSearch("node_settings_id|name");
