 ...
 * @author ramesh
 */
class Core_Modules_CoreDevelopmentsettings_Data_CoreSmsVerify
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_sms_verify");
            $registerController->setNodeNameData("core_sms_verify");
            $registerController->setDisplayValue("SMS Verify");
            ...
            $registerController->setRegisternodeId("core_sms_verify");           
            $registerController->setTablename("core_sms_verify");
