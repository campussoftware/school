 ...
 * @author ramesh
 */
class Core_Modules_CoreDevelopmentsettings_Data_CoreQueryClause
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_queryclause");
            $registerController->setNodeNameData("core_queryclause");
            $registerController->setDisplayValue("Query Clause");
            ...
            $registerController->setRegisternodeId("core_queryclause");           
            $registerController->setTablename("core_queryclause");
