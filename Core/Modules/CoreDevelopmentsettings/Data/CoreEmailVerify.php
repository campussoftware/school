 ...
 * @author ramesh
 */
class Core_Modules_CoreDevelopmentsettings_Data_CoreEmailVerify
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_email_verify");
            $registerController->setNodeNameData("core_email_verify");
            $registerController->setDisplayValue("Email Verify");
            ...
            $registerController->setRegisternodeId("core_email_verify");           
            $registerController->setTablename("core_email_verify");
