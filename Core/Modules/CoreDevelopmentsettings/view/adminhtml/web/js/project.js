function getfeeconcessionstructure()
{
   var formdata = $("form#"+$("#node").val()).serialize();
    
    var posturl=window.hosturl+'financeconcession'+"/feeconcession";
...
{
    var formdata = $("form#"+$("#node").val()).serialize();
    var posturl=window.hosturl+'financefeereceipt'+"/feestructure";
    if($("#cur_list_academicyear_id").val()=='')
    {
        displayPopupAlert("Please Select Academic Year ");
        return false;
...
{
    var formdata = $("form#report_acdprogressreport").serialize();
    var posturl=window.hosturl+'acdprogressreport'+"/getProgressReport";
...
function getbranchorintation(type)
{  
    var posturl=window.hosturl+'acdprogressreport'+"/getBranchCourses";    
    if(type=='filter')
    {
    ...
    $.ajax({
		...
		success:function(responseData)
		{
                    if(type=='filter')
                    {                        
                        $("#value_cur_branch_orientation_id").html(responseData);
                    }                    
                }
            });
    
}
function getbranchclassDetails(type)
{
    
    var posturl=window.hosturl+'acdprogressreport'+"/getBranchClasses";
    if(type=='filter')
    {
        var formData=$("form#report_acdprogressreport").serialize();
    }    
    $.ajax({
		...
		success:function(responseData)
		{
                    ...
                    if(type=='filter')
                    {                        
                        $("#value_cur_branch_class_id").html(responseData);
                    }
...
function getbranchsectionDetails(type)
{
    
    var posturl=window.hosturl+'acdprogressreport'+"/getBranchSections";
    ...
    $.ajax({
		...
		success:function(responseData)
		{
                    if(type=='filter')
                    {                        
                        $("#value_cur_branch_class_section_id").html(responseData);
                    }
                }
            });
