 ...
 * @author ramesh
 */
class Modules_Financemanagement_Data_FeeListTransactiontype
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("fee_list_transactiontype");
            $registerController->setNodeNameData("fee_list_transactiontype");
            $registerController->setDisplayValue("Transaction Type");
            $registerController->setIsModule("0");
            $registerController->setRootModuleId("financemanagement");
            $registerController->setModuleId("financesettings");
            $registerController->setModuleDisplayId("financesettings");
            ...
            $registerController->setRegisternodeId("fee_list_transactiontype");           
            $registerController->setTablename("fee_list_transactiontype");
