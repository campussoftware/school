 ...
 * @author ramesh
 */
class Modules_Financemanagement_Data_TransactionStatus
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("transaction_status");
            $registerController->setNodeNameData("transaction_status");
            $registerController->setDisplayValue("Transaction Status");
            ...
            $registerController->setRegisternodeId("transaction_status");           
            $registerController->setTablename("transaction_status");
