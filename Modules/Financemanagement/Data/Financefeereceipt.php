 ...
 * @author ramesh
 */
class Modules_Financemanagement_Data_Financefeereceipt
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("financefeereceipt");
            $registerController->setNodeNameData("transaction_logs");
            $registerController->setDisplayValue("Fee Receipt");
            ...
            $registerController->setRegisternodeId("financefeereceipt");           
            ...
            $relationController->setCoreNodeSettingsId("financefeereceipt");
