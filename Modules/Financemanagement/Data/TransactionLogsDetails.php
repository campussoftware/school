 ...
 * @author ramesh
 */
class Modules_Financemanagement_Data_TransactionLogsDetails
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("transaction_logs_details");
            $registerController->setNodeNameData("transaction_logs_details");
            $registerController->setDisplayValue("Transaction Logs Details");
            ...
            $registerController->setRegisternodeId("transaction_logs_details");           
            $registerController->setTablename("transaction_logs_details");
            ...
            $registerController->setSearch("fee_list_feetype_id|fee_list_frequency_id");
            ...
            $relationController->setCoreNodeSettingsId("transaction_logs_details");
            $relationController->setCoreNodeColname("transaction_logs_id");
            $relationController->setCoreRelationTypeId("MTO");
            $relationController->setCoreNodeParent("transaction_logs");
