 ...
 * @author ramesh
 */
class Modules_Feesetup_Data_FeeListFeegroup
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("fee_list_feegroup");
            $registerController->setNodeNameData("fee_list_feegroup");
            $registerController->setDisplayValue("Fee Group");
            ...
            $registerController->setRegisternodeId("fee_list_feegroup");           
            $registerController->setTablename("fee_list_feegroup");
