 ...
 * @author ramesh
 */
class Modules_Feesetup_Data_FeeListFrequency
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("fee_list_frequency");
            $registerController->setNodeNameData("fee_list_frequency");
            $registerController->setDisplayValue("Frequency");
            ...
            $registerController->setRegisternodeId("fee_list_frequency");           
            $registerController->setTablename("fee_list_frequency");
