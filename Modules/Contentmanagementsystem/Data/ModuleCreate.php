 ...
 * @author ramesh
 */
class Modules_Contentmanagementsystem_Data_ModuleCreate 
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("contentmanagementsystem");
            $registerController->setNodeNameData("contentmanagementsystem");
            $registerController->setDisplayValue("CMS");
            ...
            $registerController->setIcon("icon-picture");
