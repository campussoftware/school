 ...
 * @author ramesh
 */
class Modules_Studentmanagement_Data_StudentQuota
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("student_quota");
            $registerController->setNodeNameData("student_quota");
            $registerController->setDisplayValue("Student Quota");
            $registerController->setIsModule("0");
            $registerController->setRootModuleId("studentmanagement");
            $registerController->setModuleId("studentmanagement");
            $registerController->setModuleDisplayId("admissionsettings");
            ...
            $registerController->setRegisternodeId("student_quota");           
            $registerController->setTablename("student_quota");
            ...
            $registerController->setMandotatoryEdit("name|short_code|active_status");
