 ...
 * @author ramesh
 */
class Modules_Studentmanagement_Data_StudentStatus
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("student_status");
            $registerController->setNodeNameData("student_status");
            $registerController->setDisplayValue("Student Status");
            ...
            $registerController->setRegisternodeId("student_status");           
            $registerController->setTablename("student_status");
