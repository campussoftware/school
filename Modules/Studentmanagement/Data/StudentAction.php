 ...
 * @author ramesh
 */
class Modules_Studentmanagement_Data_StudentAction
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("student_action");
            $registerController->setNodeNameData("student_action");
            $registerController->setDisplayValue("Student Action");
            ...
            $registerController->setRegisternodeId("student_action");           
            $registerController->setTablename("student_action");
