 ...
 * @author ramesh
 */
class Modules_Studentmanagement_Setup_StudentHistory
{
    //put your code here
    function execute()
    {
        $setup=new Core_DataBase_Setup();   
        $setup->setTable("student_history");
        if(!$setup->tableExists($setup->getTable()))
        {
            $setup->setDisplayValue("Student History");
            $setup->addColumnName(array(
                "name"=>"id",
                "displayValue"=>"Student History Id",
                "prmiary"=>1,            
                "default"=>NULL,
                "type"=>"bigint",
                "size"=>"11",
