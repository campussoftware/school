 ...
 * @author ramesh
 */
class Modules_Expensemanagement_Data_ExpenseStatus
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("expense_status");
            $registerController->setNodeNameData("expense_status");
            $registerController->setDisplayValue("Expense Status");
            ...
            $registerController->setRegisternodeId("expense_status");           
            $registerController->setTablename("expense_status");
