 ...
 * @author ramesh
 */
class Modules_Staffmanagement_Setup_StaffAttendance
{
    //put your code here
    function execute()
    {
        $setup=new Core_DataBase_Setup();   
        $setup->setTable("staff_staff_attendance");
        if(!$setup->tableExists($setup->getTable()))
        {
            $setup->setDisplayValue("Staff Attendance");
            $setup->addColumnName(array(
                "name"=>"id",
                "displayValue"=>"Staff Attendance Id",
                "prmiary"=>1,
                "default"=>NULL,
                "type"=>"int",
                "size"=>"15",
