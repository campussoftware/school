 ...
 * @author ramesh
 */
class Modules_Curriculum_Data_CurOrientationLevel
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("cur_orientation_level");
            $registerController->setNodeNameData("cur_orientation_level");
            $registerController->setDisplayValue("Course Level");
            ...
            $registerController->setRegisternodeId("cur_orientation_level");           
            $registerController->setTablename("cur_orientation_level");
