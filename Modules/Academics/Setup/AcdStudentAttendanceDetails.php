 ...
 * @author ramesh
 */
class Modules_Academics_Setup_AcdStudentAttendanceDetails
{
    //put your code here
    function execute()
    {
        $setup=new Core_DataBase_Setup();   
        $setup->setTable("acd_student_attendance_details");
        if(!$setup->tableExists($setup->getTable()))
        {
            $setup->setDisplayValue("Acd Student Attendance Details");
            ...
            $setup->addColumnName(array(
                "name"=>"acd_student_attendance_id",
                "displayValue"=>"Student Attendence Id",            
                "default"=>NULL,  
                "type"=>"int",
                "size"=>"11"         
            ));
            ...
            $setup->addColumnName(array(
                "name"=>"cur_list_attendancefrequency_id",
                "displayValue"=>"List Attendancefrequency Id",            
                "default"=>NULL,                
                "type"=>"varchar",
                "size"=>"255"          
            ));
            $setup->addColumnName(array(
                "name"=>"core_attendance_status_id",
