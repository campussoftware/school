 ...
 * @author ramesh
 */
class Modules_Academics_Data_AcdGradeType
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("acd_grade_type");
            $registerController->setNodeNameData("acd_grade_type");
            $registerController->setDisplayValue("Grade Type");
            ...
            $registerController->setRegisternodeId("acd_grade_type");           
            $registerController->setTablename("acd_grade_type");
