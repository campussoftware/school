 ...
 * @author ramesh
 */
class Modules_Notificationmanagement_Data_CmsNotificationType
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("cms_notification_type");
            $registerController->setNodeNameData("cms_notification_type");
            $registerController->setDisplayValue("Notification Type");
            $registerController->setIsModule("0");
            $registerController->setRootModuleId("notificationmanagement");
            $registerController->setModuleId("notification_settings");
            $registerController->setModuleDisplayId("notification_settings");
            ...
            $registerController->setRegisternodeId("cms_notification_type");           
            $registerController->setTablename("cms_notification_type");
